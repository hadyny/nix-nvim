...
api.nvim_create_user_command('LspInfo', function()
  ...
  if #clients == 0 then
    ...
    for _, client in ipairs(clients) do
      ...
      table.insert(lines, string.format('  autostart: %s', tostring(client.config.autostart ~= false)))
  ...
  api.nvim_buf_set_option(info_buf, 'bufhidden', 'wipe')
  api.nvim_buf_set_option(info_buf, 'filetype', 'lspinfo')
