-- vscode-eslint-language-server. Migrated from user.web_servers; the elaborate
-- before_init/handlers/settings are preserved verbatim. root_markers replaces
-- the old vim.fs.find(root_dir); workspace_required keeps it from attaching to
-- loose files, matching the previous behaviour.
