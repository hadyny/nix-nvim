---@mod user.web_servers
---
---@brief [[
---Shared starters for LSP servers that attach to multiple web filetypes
---(typescript, astro, etc.). Each starter is idempotent: native vim.lsp.start
---deduplicates on { name, cmd, root_dir }.
---@brief ]]
